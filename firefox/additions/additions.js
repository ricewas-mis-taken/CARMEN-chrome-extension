...
async function load() {
  ...
  const { domainWhitelist: savedWhitelist } = await getCachedRules(browser.storage.local);
...
addSelectedBtn.addEventListener("click", async () => {
  ...
  await saveWhitelist({ storageApi: browser.storage.local, domainWhitelist: updatedWhitelist });
